...
if lightline#colorscheme#background() ==# 'light'
    ...
    let s:p.normal.left = [[ s:bryellow, s:cordovan, 'bold' ], [ s:bryellow, s:blue ], [ s:bryellow, s:yellow ]]
    let s:p.normal.right = [[ s:bryellow, s:cordovan, 'bold' ], [ s:bryellow, s:blue ], [ s:bryellow, s:yellow ]]
